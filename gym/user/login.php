<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $login_query="SELECT * FROM `member` WHERE musername='$musername' and mpassword='$mpassword' and mtype='Member'";
        ...
        <div class="transbox">
          <?php echo $message; ?>
           <div class="page-header">
               <h1 style="text-align: center;">Member SignIn</h1>
         </div>
           <form class="form-horizontal animated bounce" action="" method="post">
             ...
             <br>
             <div class="input-group">
                <p> Sign in as trainer? <a href="trainerlogin.php">Click here</a> </p>
