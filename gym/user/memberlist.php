...
<script type="text/javascript">
 ...
 {
    if(confirm('Sure To Remove This Member ?'))
    {
     window.location.href='deletemember.php?delete_id='+memberid;
    }
 }
</script>
<body>
      ...
      <div class="container">
        <div class="row">
            <div class="page-header">
                <h2 style="text-align: center;">Alpha Fitness Member</h2>
                <br/>
            </div>
        </div>
            <div class="col-md-12">
            <table class="table">
             ...
             <?php
              $sql="SELECT * FROM `member` WHERE `mtype`= 'Member'";
